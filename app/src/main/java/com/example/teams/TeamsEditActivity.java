...
public class TeamsEditActivity extends AppCompatActivity implements RaterDialog.SaveRatingListener {
    ...
    private void readFromAPI(int teamId)
    {
        try{
            ...
            RestClient.execGetOneRequest(getString(R.string.https_fvtcdp_azurewebsites_net_api_team) + teamId,
                    this,
                    new VolleyCallback() {
                        @Override
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(teamId == -1)
                {
                    ...
                    RestClient.execPostRequest(team, getString(R.string.https_fvtcdp_azurewebsites_net_api_team),
                    ...
                    //ds.update(team);
                    RestClient.execPutRequest(team, getString(R.string.https_fvtcdp_azurewebsites_net_api_team) + teamId,
                            TeamsEditActivity.this,
                            new VolleyCallback() {
                                @Override
                                public void onSuccess(ArrayList<Team> result) {
