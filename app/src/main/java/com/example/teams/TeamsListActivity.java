...
public class TeamsListActivity extends AppCompatActivity {
    ...
    private void initDatabase() {
        ...
        ds.open(false);
        String sortBy = getSharedPreferences("teamspreferences", Context.MODE_PRIVATE).getString("sortby", "name");
        String sortOrder = getSharedPreferences("teamspreferences", Context.MODE_PRIVATE).getString("sortorder", "ASC");
    ...
    private void readFromAPI(){
        try {
            ...
            RestClient.execGetRequest(getString(R.string.https_fvtcdp_azurewebsites_net_api_team), this, new VolleyCallback() {
                @Override
